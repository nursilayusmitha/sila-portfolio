...
export const BentoGridItem = ({
  ...
  const [pageFlipSound, setPageFlipSound] = useState<HTMLAudioElement | null>(null);
  const [isMobile, setIsMobile] = useState(false);

  useEffect(() => {
    if (typeof window !== "undefined") {
      const checkMobile = window.matchMedia("(max-width: 999px)").matches;
    ...
    <div
      ...
      onClick={() => {
        if (id === 4) {
          ...
          if (isMobile && pageFlipSound) {
            pageFlipSound.currentTime = 0;
            pageFlipSound.play().catch((e) =>
              console.error("Error playing flip sound:", e)
            );
          }
        }
      }}
                        ...
                        >
                          <img
                            ...
                            className="
                              ...
                              1140:w-4 1140:h-4
                              1300:w-6 1300:h-6
                              mr-2 1000:mr-1 1145:mr-2 1300:mr-3
                            "
                          />
                          <span className="
